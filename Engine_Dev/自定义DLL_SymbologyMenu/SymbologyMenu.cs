...
namespace 自定义DLL_SymbologyMenu
{
    ...
    /// </summary>
    [Guid("26866a9f-f323-47de-b124-9a7b878cfb97")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SymbologyMenu.SymbologyMenu")]
    public sealed class SymbologyMenu : BaseMenu
    {
        ...
        public SymbologyMenu()
        {
            ...
            AddItem("Symbology.ProportionalSymbol");
        ...
        public int ItemCount{get{return 6;}}
        public void GetItemInfo(int pos,IItemDef itemDef)
        {
            switch (pos)
            {
                case 0: itemDef.ID = "Symbology.SimpleRender"; break;//简单着色
                case 1: itemDef.ID = "Symbology.UniqueValueRender"; break;//唯一值着色
                case 2: itemDef.ID = "Symbology.ClassBreakRender"; break;//分级着色
                case 3: itemDef.ID = "Symbology.ProportionalSymbol"; break;//按比例着色
                case 5: itemDef.ID = "Symbology.DotDensityRender"; break;//点密度图
                case 4: itemDef.ID = "Symbology.BarChartRender"; break;//饼图
            }
        }
    }
}